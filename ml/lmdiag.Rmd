...
# Introduction
As useful as linear regression is, it has conditions. Let's take a look at how to figure out when we can use it.

## Why linear regression
This section is unnecessary. Make separate projects for analyzing datasets.
